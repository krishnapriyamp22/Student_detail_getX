...
import 'package:student_getx/database/student.dart';
import 'package:student_getx/other/color.dart';
import 'package:student_getx/other/validator.dart';
            ...
            children: [
              ...
              widget.isEdit
                  ...
                  : ElevatedButton.icon(
                      ...
                      style: ButtonStyle(
                        backgroundColor:
                            MaterialStateProperty.all<Color>(const Color(0xFF2E294E)),
                        elevation: MaterialStateProperty.all<double>(3),
                        shape: MaterialStateProperty.all<OutlinedBorder>(
                          RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(20.0),
